    ...
    <>
      <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <input
          ...
          className="w-full border border-line bg-raised px-4 py-3 font-mono text-sm text-paper placeholder:text-dim focus:border-paper focus:outline-none sm:max-w-sm"
        />
        <select
          value={sort}
          onChange={(e) => setSort(e.target.value as Sort)}
          className="border border-line bg-raised px-4 py-3 font-mono text-xs uppercase tracking-widest2 text-dim focus:border-paper focus:outline-none"
        >
      ...
      <p className="mb-6 font-mono text-xs uppercase tracking-widest2 text-dim">
