...
export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-line">
      <div
        className="pointer-events-none absolute inset-0 bg-blueprint bg-grid opacity-[0.18]"
        style={{
          maskImage: "radial-gradient(ellipse 65% 90% at 22% 40%, #000 0%, transparent 72%)",
          WebkitMaskImage: "radial-gradient(ellipse 65% 90% at 22% 40%, #000 0%, transparent 72%)",
        }}
        aria-hidden
      />
