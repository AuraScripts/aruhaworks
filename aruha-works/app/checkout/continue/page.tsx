  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (mode === "cart") {
          // Just adding to cart — return to the shop, no checkout popup.
          window.location.href = "/";
          return;
        }

        // Buy-now flow — return to the storefront and open the Tebex
        // checkout overlay there (see components/CheckoutLauncher.tsx).
